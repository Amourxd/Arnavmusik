...
from callmusic.config import BOT_USERNAME as bn, SUDO_USERS
...
@Kanna.on_message(command(["song", f"song@{bn}"]) & ~filters.edited)
def song(_, message):
    ...
    try:
        ...
        rep = f"**🎵 ʊքʟօǟɖɨռɢ ɮʏ :- ✨ @Arnavserver ❤**"
...
async def download_song(url):
    ...
    async with aiohttp.KannaSession() as session:
