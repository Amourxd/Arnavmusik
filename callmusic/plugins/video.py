...
from helper.inline import stream_markup, audio_markup
...
from callmusic import call_py, kanna as user
...
IMAGE_THUMBNAIL = "https://telegra.ph/file/8eea7dbdf2da5fa4292e7.jpg"
...
@Kanna.on_message(command(["vplay", f"vplay@{BOT_USERNAME}"]) & other_filters)
async def vplay(c: Kanna, m: Message):
    await m.delete()
        ...
        if replied.video or replied.document:
            ...
            if chat_id in QUEUE:
                ...
                await m.reply_photo(
                    ...
                    caption=f"**❰ 𝗥𝗲𝘀𝘀𝗼 𝗠𝘂𝘀𝗶𝗸 ❱ 𝗦𝗼𝗻𝗴 ❤️ 𝗣𝗼𝘀𝗶𝘁𝗶𝗼𝗻 💫🤟**\n🧸 **𝗥𝗲𝗾𝘂𝗲𝘀𝘁 𝗯𝘆:** {requester}",
                )
            else:
                if Q == 720:
                ...
                await m.reply_photo(
                    photo=thumbnail,
                    reply_markup=InlineKeyboardMarkup(buttons),
                    caption=f"**❰ 𝗥𝗲𝘀𝘀𝗼 𝗠𝘂𝘀𝗶𝗰 ❱ 𝗡𝗼𝘄 😄 𝗣𝗹𝗮𝘆𝗶𝗻𝗴 📀 𝗔𝘁 🤟**\n🧸 **Request by:** {requester}",
                )
        else:
            if len(m.command) < 2:
                await m.reply_text(
                    ...
                    if shub == 0:
                        ...
                        if chat_id in QUEUE:
                            ...
                            await m.reply_photo(
                                photo=queueimg,
                                reply_markup=InlineKeyboardMarkup(buttons),
                                caption=f"**❰ 𝗥𝗲𝘀𝘀𝗼 𝗠𝘂𝘀𝗶𝗸 ❱ 𝗡𝗼𝘄 😄 𝗣𝗹𝗮𝘆𝗶𝗻𝗴 📀 𝗔𝘁 🤟\n**𝗥𝗲𝗾𝘂𝗲𝘀𝘁 𝗯𝘆:** {requester}",
                            )
                        else:
                            try:
                                await loser.edit(
                            f"**🔄 𝐏𝐫𝐨𝐜𝐞𝐬𝐬𝐢𝐧𝐠 ...**"
                                ...
                                await m.reply_photo(
                                    photo=playimg,
                                    reply_markup=InlineKeyboardMarkup(buttons),
                                    caption=f"**❰ 𝗥𝗲𝘀𝘀𝗼 𝗠𝘂𝘀𝗶𝗸 ❱ Now 😄 𝗣𝗹𝗮𝘆𝗶𝗻𝗴 📀 𝗔𝘁 🤟**\n**𝗥𝗲𝗾𝘂𝗲𝘀𝘁 𝗯𝘆:** {requester}",
                                )
